...
def joinFactors(factors: List[Factor]):
    ...
    result = Factor(unconditionedSet, conditionedSet, variableDomains)
    for i in result.getAllPossibleAssignmentDicts():
        num = 1
        for factor in factors:
            num = factor.getProbability(i) * num
        result.setProbability(i, num)
...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        for i in result.getAllPossibleAssignmentDicts():
            num = 0
            for j in variableDomains[eliminationVariable]:
